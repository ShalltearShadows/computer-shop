<template>
    <div>
        ...
        <el-card class="box-card">
            ...
            <el-table :data="rolesList" stripe border>
                ...
                <el-table-column label="操作">
                    <template v-slot="scope">
                        <el-button size="mini" type="primary" icon="el-icon-edit" @click="showEditNameForm(scope.row)">编辑</el-button>
        ...
        <el-dialog title="添加新角色" :visible.sync="setAddRoleDialogVisible" width="50%" @close="addRoleDialogClosed">
          <!--输入区-->
          <el-form :model="addRoleForm" :rules="addRoleFormRules" ref="addRoleFormRef" label-width="80px" class="demo-ruleForm">
        ...
        <el-dialog title="编辑角色名" :visible.sync="setEditNameDialogVisible" width="50%" @close="editNameDialogClosed">
          <!--输入区-->
          <el-form :model="editNameForm" :rules="editNameFormRules" ref="editNameFormRef" label-width="80px" class="demo-ruleForm">
      ...
      <el-dialog title="分配权限" :visible.sync="setRightDialogVisible" width="50%">
        ...
        <el-tree :data="rightsList" show-checkbox default-expand-all node-key="id"
                 :default-checked-keys="defKeys" :props="this.treeProps" ref="treeRef">
        </el-tree>
        <span slot="footer" class="dialog-footer">
